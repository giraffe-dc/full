                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: '8px',
                                        borderRadius: '6px',
                                        border: '1px solid #bfc4cfff',
                                        background: form.type === 'income' ? '#7ef1a6ff' : 'white',
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: '8px',
                                        borderRadius: '6px',
                                        border: '1px solid #eeb69cff',
                                        background: form.type === 'expense' ? '#f0a0a0ff' : 'white',
