...
async function run() {
  ...
  try {
    ...
    const adminEmail = 'giraffe.teplik12@gmail.com';
    const adminPassword = process.env.SEED_ADMIN_PASSWORD || 'GiraFFe2025';
    ...
    const res = await users.insertOne({ name: 'Administrator', email: adminEmail, password: hashed, role: 'user', createdAt: new Date() });
